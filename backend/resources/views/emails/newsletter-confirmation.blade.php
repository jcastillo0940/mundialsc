...
<head>
  ...
  <title>Confirma tu suscripción · {{ $appName }}</title>
  <!--[if mso]>
...
<div style="display:none;max-height:0;overflow:hidden;mso-hide:all;font-size:1px;color:#020b27;line-height:1px">
  Hola {{ $name }}, confirma tu suscripción para recibir novedades de {{ $appName }}.&nbsp;‌&nbsp;‌&nbsp;‌&nbsp;‌&nbsp;‌&nbsp;‌&nbsp;‌&nbsp;‌&nbsp;‌&nbsp;‌&nbsp;‌&nbsp;‌&nbsp;‌
</div>
            ...
            <table role="presentation" cellspacing="0" cellpadding="0" border="0">
              <tr>
                <td style="background-color:#0a1e5e;border:1px solid #1a3b8a;border-radius:999px;padding:5px 14px">
                  <span style="font-family:Arial,sans-serif;font-size:11px;font-weight:700;color:#7ab8ff;letter-spacing:0.1em;text-transform:uppercase">Newsletter</span>
                </td>
              </tr>
            </table>
            <h1 style="margin:16px 0 12px;font-family:Arial,sans-serif;font-size:28px;font-weight:900;color:#ffffff;line-height:1.1;letter-spacing:-0.02em">¡Ya casi estás<br>adentro!</h1>
            <p style="margin:0;font-family:Arial,sans-serif;font-size:15px;color:#7a9ab8;line-height:1.65">
              Hola <strong style="color:#e8eeff">{{ $name }}</strong>, recibimos tu solicitud para recibir novedades y noticias de <strong style="color:#e8eeff">{{ $appName }}</strong>.
            </p>
          </td>
        </tr>
              ...
              <tr>
                <td style="padding:24px 24px 8px">
                  <p style="margin:0;font-family:Arial,sans-serif;font-size:15px;color:#c4d8f0;line-height:1.65">
                    Confirma tu correo electrónico para activar la suscripción y ser el primero en enterarte de resultados, pronosticos y premios.
                  </p>
                </td>
              </tr>
              <tr>
            ...
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background-color:#020b27;border:1px solid #0d2d6e;border-radius:14px">
              <tr>
                <td style="padding:16px 20px">
                  <p style="margin:0 0 4px;font-family:Arial,sans-serif;font-size:11px;font-weight:700;color:#ffd454;letter-spacing:0.1em;text-transform:uppercase">Doble opt-in</p>
                  <p style="margin:0;font-family:Arial,sans-serif;font-size:13px;color:#4a6a8a;line-height:1.6">Si no solicitaste esta suscripción, simplemente ignora este correo. No se activará nada sin tu confirmación.</p>
                </td>
              </tr>
            </table>
          </td>
